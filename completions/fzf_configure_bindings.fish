...
complete fzf_configure_bindings --long git_branch --description "Change the key binding for Search Git Branch" --condition "not __fish_seen_argument --git_branch"
